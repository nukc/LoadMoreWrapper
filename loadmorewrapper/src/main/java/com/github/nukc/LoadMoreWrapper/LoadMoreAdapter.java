...
public class LoadMoreAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
	...
	private boolean mNotShowFooterWhenNotCoveredScreen = false;
	...
	public int getItemViewType(int position) {
		...
		if (position == mAdapter.getItemCount() && (getLoadMoreEnabled() || mShouldRemove)) {
			return getItemViewTypeWhenNotCoveredScreen(TYPE_FOOTER);
	...
	private int getItemViewTypeWhenNotCoveredScreen(int viewType) {
		if (mNotShowFooterWhenNotCoveredScreen && !canScroll()) {
	...
	private final OnEnabledListener mOnEnabledListener = new OnEnabledListener() {
		@Override
	...
	public boolean isNotShowFooterWhenNotCoveredScreen() {
		return mNotShowFooterWhenNotCoveredScreen;
	}

	public void setNotShowFooterWhenNotCoveredScreen(boolean notShow) {
		this.mNotShowFooterWhenNotCoveredScreen = notShow;
	}
